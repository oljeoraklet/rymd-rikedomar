...
namespace SpaceConsoleMenu
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<StoreItem<IStoreItem>> storeItems = new();

            storeItems.Add(new StoreItem<IStoreItem>(new Spice(), 100));

            storeItems.Add(new StoreItem<IStoreItem>(new Metal(), 100));

            var item = storeItems.OfType<StoreItem<IStoreItem>>().FirstOrDefault(i => i.Item.Name == "Krydda");
